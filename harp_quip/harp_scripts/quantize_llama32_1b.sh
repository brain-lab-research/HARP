...
OUT_NAME="32_1b_2bit_harp"
SAVE_PATH="$CKPT/$OUT_NAME"
HESS_PATH="$HESS/llama32_1b_hess"
HF_PATH="$HF/$OUT_NAME"
...
python scripts/download_hf.py --folder_path "$HESS_PATH" --repo_id relaxml/Llama-3.2-1B-Instruct-Hessians
