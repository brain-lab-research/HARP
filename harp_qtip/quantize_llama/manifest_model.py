    ...
    for name in names:
        ...
        if isinstance(module, QuantizedLinear):
            module.codebook_class.cache_hatW(
                ...
                module.rcp,
                module.tp_rank,
                incoh_mode=module.incoh_mode,
            )

            if getattr(module, "incoh_mode", "had") == "harp":
                w_tilde = module.codebook_class.hatW.float()
                w_signed = module.harp.inverse_transform_weights(w_tilde)
                w = ((w_signed * module.SU).T * module.SV).T * module.codebook_class.scale
            else:
            ...
            if hasattr(module.codebook_class, "hatW"):
